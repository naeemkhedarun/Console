...
New-ItemProperty "HKCU:\Software\Classes\*\shell\Open ConEmu" "Icon" -Value "$InstallPath\Icons\PowerShellPrompt.ico" -Type String -Force | Out-Null
...
New-ItemProperty "HKCU:\Software\Classes\Directory\Background\shell\Open ConEmu" "Icon" -Value "$InstallPath\Icons\PowerShellPrompt.ico" -Type String -Force | Out-Null
...
New-ItemProperty "HKCU:\Software\Classes\Directory\shell\Open ConEmu" "Icon" -Value "$InstallPath\Icons\PowerShellPrompt.ico" -Type String -Force | Out-Null
...
New-ItemProperty "HKCU:\Software\Classes\Drive\shell\Open ConEmu" "Icon" -Value "$InstallPath\Icons\PowerShellPrompt.ico" -Type String -Force | Out-Null
...
New-ItemProperty "HKCU:\Software\Classes\*\shell\Open ConEmu (Embedded)" "Icon" -Value "$InstallPath\Icons\PowerShellPrompt.ico" -Type String -Force | Out-Null
...
New-ItemProperty "HKCU:\Software\Classes\Directory\Background\shell\Open ConEmu (Embedded)" "Icon" -Value "$InstallPath\Icons\PowerShellPrompt.ico" -Type String -Force | Out-Null
...
New-ItemProperty "HKCU:\Software\Classes\Directory\shell\Open ConEmu (Embedded)" "Icon" -Value "$InstallPath\Icons\PowerShellPrompt.ico" -Type String -Force | Out-Null
...
New-ItemProperty "HKCU:\Software\Classes\Drive\shell\Open ConEmu (Embedded)" "Icon" -Value "$InstallPath\Icons\PowerShellPrompt.ico" -Type String -Force | Out-Null
